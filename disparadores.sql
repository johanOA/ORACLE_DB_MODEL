...
--procedimiento para crear x cantidad de bancos a un examen con preguntas de un tema dado aleatoriamente
CREATE OR REPLACE PROCEDURE CREAR_PREGUNTAS_ALEATORIAS(
    IDEXAMENEN NUMBER,
    IDTEMA NUMBER,
...
--VALIDA SI LA CANTIDAD DE BANCOPREGUNTAS ES MENOR A LA CANTIDADPREGUNTAS DE UN EXAMEN PARA CREAR LA CANTIDAD DE BANCOS FALTANTES
CREATE OR REPLACE TRIGGER RELLENAR_PREGUNTAS_EXAMEN
...
BEGIN    
    IF :NEW.ESTADO = 'Borrador' THEN
        SELECT COUNT(EXAMENES_IDEXAMENEN)
        INTO V_CANTIDAD_BANCOS
        FROM bancopreguntas
        WHERE examenes_idexamenen = :NEW.IDEXAMENEN;
